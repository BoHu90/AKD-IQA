...
def set_args():
    ...
    # 训练数据集
    parser.add_argument('--train_dataset', type=str, default='kadid10k',
                        help='Support datasets: pipal|livec|koniq-10k|bid|live|csiq|tid2013|kadid10k')
    # 测试数据集
    parser.add_argument('--test_dataset', type=str, default='csiq',
                        help='Support datasets: pipal|livec|koniq-10k|bid|live|csiq|tid2013|kadid10k')
    ...
    parser.add_argument('--teacherNet_model_path', type=str, default=None,
                        help='./model_zoo/FR_teacher_cross_dataset.pth')
